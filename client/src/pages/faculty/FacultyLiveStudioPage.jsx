...
export default function FacultyLiveStudioPage() {
  ...
  const [streamTitle, setStreamTitle] = useState(
    "Data Structures Live Masterclass",
  );
      ...
      setMessages([
        {
          ...
          role: "Faculty",
          text: "🎙️ Live class has started!",
          time: new Date().toLocaleTimeString(),
        },
      ]);
    } catch (err) {
      if (err.name === "NotAllowedError") {
        setCameraError("Camera/microphone access denied.");
      } else {
  ...
  const endLive = async () => {
    if (!window.confirm("End broadcast?")) return;
  ...
  const toggleCamera = () => setIsCameraOff((c) => !c);
  ...
  return (
    <ProtectedLayout
      title="Faculty Live Broadcast Studio"
    ...
    >
      ...
      {!isLive ? (
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(99,102,241,0.1) 0%, rgba(16,185,129,0.08) 100%)",
            border: "1px solid var(--border-color)",
          }}
        >
          <h2 className="text-xl font-bold mb-md">
            🎙️ Set Up Your Live Broadcast
          </h2>
          <div
          ...
          >
            <div className="form-group">
              ...
              <input
                ...
                placeholder="e.g. Data Structures Live Masterclass"
              />
            </div>
            <div className="form-group">
          ...
          <div className="flex justify-between items-center flex-wrap gap-md">
            <div className="flex items-center gap-md">
              ...
              <div>
                ...
                <p className="text-secondary text-sm">
                  Host: {user?.name || "Faculty"} • Subject: {subject}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-md">
              <div
                ...
                style={{ minWidth: 140, margin: 0, textAlign: "center" }}
              >
          ...
          >
            {isCameraOff && isLive ? (
              <div style={{ textAlign: "center", color: "#fff" }}>
                ...
                <p style={{ fontWeight: 600, color: "#aaa", marginTop: 8 }}>
                  Camera Paused
                </p>
              </div>
            ) : (
            ...
            <div className="text-xs text-secondary font-semibold">
              {isLive ? (
                <span className="text-success">
                  ● Broadcasting Live • Viewers: {viewerCount}
                </span>
              ) : (
                <span className="text-muted">
                  ● Offline — Click Go Live to start
                </span>
              )}
            </div>
          </div>
        ...
        >
          ...
          <form onSubmit={sendChat} className="p-sm border-t flex gap-xs">
            <input
              ...
              placeholder={
                isLive
                  ? "Say something to your students..."
                  : "Go live to chat..."
              }
              value={chatInput}
