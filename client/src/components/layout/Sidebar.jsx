    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: '0.65rem', color: '#64748b' }}>Assessment Platform</div>
            </div>
          </div>
        ...
        <nav style={{ flex: 1, padding: '10px 8px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 2 }}>
          <div style={{ fontSize: '0.6rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#475569', padding: '8px 12px 4px' }}>
            Navigation
          </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gap: '10px', padding: '10px 12px', borderRadius: 8, cursor: 'pointer',
